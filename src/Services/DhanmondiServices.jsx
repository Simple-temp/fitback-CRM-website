...
const DhanmondiServices = () => {
    ...
    onSubmit: async (values) => {
      try {
        ...
        const response = await axios.put(
          `https://qwikit1.pythonanywhere.com/resetPackageDhanmondi/${getUserToUpdate.id}`,
          formData,
  ...
  const updatingUserId = async (id) => {
    try {
      const response = await axios.get(
        `https://qwikit1.pythonanywhere.com/resetPackageDhanmondi/${id}`
      );
...
export default DhanmondiServices;
